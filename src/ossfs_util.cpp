...
string get_username(uid_t uid)
{
  ...
  // make buffer
  if(0 == maxlen){
    long ret = sysconf(_SC_GETPW_R_SIZE_MAX);
    if(ret < 0){
...
{
  return static_cast<time_t>(ossfs_strtoofft(s));
}
...
void show_help (void)
{
  ...
  printf( 
    ...
    "          see http://www.aliyun.com/product/oss/ for the \n"
    ...
    "      - this option makes Aliyun's Server Site Encryption enable.\n"
    "\n"
    ...
    */
    ...
    "      For delayed reading and writing by ossfs, ossfs manages pages which \n"
    ...
    "      with performance.\n"
    "\n"
    "   url (default=\"http://oss-cn-hangzhou-internal.aliyuncs.com\")\n"
    ...
    */
    ...
    "\n"
    /*
    "Report bugs to <ossfs-devel@googlegroups.com>\n"
    "ossfs home page: <http://code.google.com/p/ossfs/>\n"
    */
  );
  return;
}
